    ...
    documents: {
      ...
      privacy: {
        ...
        sections: [
          ...
          { title: 'Données utilisées', bullets: ['préférences de langue et d’unités enregistrées dans le navigateur ;', 'briefings, observations, débriefings et séances d’entraînement saisis par l’utilisateur ;', 'adresse e-mail, identifiant technique et jetons de session lors de la connexion Firebase ;', 'positions GPS du coach, événements géolocalisés et traces GPX importées, uniquement lorsque l’utilisateur active ou fournit ces données.'] },
  ...
  en: {
    ...
    documents: {
      ...
      privacy: { title: 'Privacy policy', introduction: 'This page explains which data CoachBrief uses, why it is used and how to exercise your rights.', sections: [
        ...
        { title: 'Data used', bullets: ['language and unit preferences stored in the browser;', 'briefings, observations, debriefs and training sessions entered by the user;', 'email address, technical identifier and session tokens when signing in through Firebase;', 'coach GPS positions, geolocated events and imported GPX tracks, only when the user enables or supplies this data.'] },
