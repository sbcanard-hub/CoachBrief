...
const translations: Record<OffshoreLanguage, TranslationSet> = {
  en: {
    ...
    'Route': 'Route',
    'Départ, waypoints et arrivée': 'Start, waypoints and finish',
    'Départ': 'Start',
    'Arrivée': 'Finish',
    'La recherche place automatiquement D ou A. Les coordonnées restent modifiables à la main, les marqueurs peuvent être déplacés sur la carte et les waypoints intermédiaires restent indépendants.': 'Search places D or A automatically. Coordinates can still be edited manually, markers can be dragged on the map and intermediate waypoints remain independent.',
    'Nom': 'Name',
    'Latitude': 'Latitude',
    'Longitude': 'Longitude',
    'Ajouter un waypoint manuel': 'Add a manual waypoint',
    'Carte de route': 'Route map',
    ...
    'Distance directe D → A': 'Direct distance D → A',
    'Route météo calculée': 'Calculated weather route',
    'Route météo partielle': 'Partial weather route',
    '1 tronçon': '1 leg',
    'Météo au passage': 'Weather along the route',
    'Polaire bateau': 'Boat polar',
    ...
    'Routage météo': 'Weather routing',
    'Isochrones': 'Isochrones',
    'Pas de temps': 'Time step',
    'Horizon': 'Horizon',
    'Coefficient marée': 'Tide coefficient',
    'PM générique de secours': 'Fallback high water',
    'Calculer le routage': 'Calculate routing',
    'Calcul des isochrones…': 'Calculating isochrones…',
    ...
    'Aucune PM saisie': 'No high water entered',
    'Pourquoi cette route météo ?': 'Why this weather route?',
    'Cap': 'Heading',
    'Vent': 'Wind',
    'TWA': 'TWA',
    'Polaire': 'Polar',
    'Après mer': 'After sea-state penalty',
    'Vitesse sol': 'Speed over ground',
    'Courant': 'Current',
    'Isochrones ': 'Isochrones ',
    'Route retenue': 'Selected route',
    'Arrivée ': 'Finish ',
    'Coupures de terre écartées': 'Land crossings rejected',
    'Options coupant un TSS': 'Options crossing a TSS',
    'Échantillons courant SHOM': 'SHOM current samples',
    'PM de port utilisées': 'Port high waters used',
    'PM propagées ~12 h 25': 'High waters propagated ~12 h 25',
    'Replis Open-Meteo': 'Open-Meteo fallbacks',
    'Atlas SHOM utilisés': 'SHOM atlases used',
  ...
  it: {
    'CoachBrief · Course au large': 'CoachBrief · Regata d’altura',
    'Préparer une route qui évolue': 'Preparare una rotta che evolve',
    'dans le temps et dans l’espace': 'nel tempo e nello spazio',
    ...
    'Course': 'Regata',
    'Départ et bateau': 'Partenza e barca',
    'Nom de la course': 'Nome della regata',
    'Date de départ': 'Data di partenza',
    'Heure de départ': 'Ora di partenza',
    'Nom du bateau': 'Nome della barca',
    'Nom ou numéro': 'Nome o numero',
    'Type de bateau': 'Tipo di barca',
    'Vitesse moyenne de travail': 'Velocità media di lavoro',
    ...
    'Route': 'Rotta',
    'Départ, waypoints et arrivée': 'Partenza, waypoint e arrivo',
    'Départ': 'Partenza',
    'Arrivée': 'Arrivo',
    'Nom': 'Nome',
    'Latitude': 'Latitudine',
    'Longitude': 'Longitudine',
    'Ajouter un waypoint manuel': 'Aggiungi un waypoint manuale',
    'Carte de route': 'Carta della rotta',
    ...
    'Distance directe D → A': 'Distanza diretta D → A',
    'Route météo calculée': 'Rotta meteo calcolata',
    'Route météo partielle': 'Rotta meteo parziale',
    '1 tronçon': '1 tratta',
    'Météo au passage': 'Meteo lungo la rotta',
    'Polaire bateau': 'Polare barca',
    ...
    'Routage météo': 'Routing meteo',
    'Isochrones': 'Isocrone',
    'Pas de temps': 'Passo temporale',
    'Horizon': 'Orizzonte',
    'Coefficient marée': 'Coefficiente di marea',
    'PM générique de secours': 'Alta marea di riserva',
    'Calculer le routage': 'Calcola il routing',
    'Calcul des isochrones…': 'Calcolo delle isocrone…',
    'Pleines mers par port de référence SHOM': 'Alte maree per porto SHOM di riferimento',
    'Aucune PM saisie': 'Nessuna alta marea inserita',
    'Pourquoi cette route météo ?': 'Perché questa rotta meteo?',
    'Cap': 'Rotta',
    'Vent': 'Vento',
    'Polaire': 'Polare',
    'Après mer': 'Dopo penalità mare',
    'Vitesse sol': 'Velocità sul fondo',
    'Courant': 'Corrente',
    'Route retenue': 'Rotta selezionata',
    'Coupures de terre écartées': 'Attraversamenti di terra scartati',
    'Options coupant un TSS': 'Opzioni che attraversano un TSS',
    'Échantillons courant SHOM': 'Campioni corrente SHOM',
  ...
  es: {
    'CoachBrief · Course au large': 'CoachBrief · Regata de altura',
    'Préparer une route qui évolue': 'Preparar una ruta que evoluciona',
    'dans le temps et dans l’espace': 'en el tiempo y en el espacio',
    ...
    'Course': 'Regata',
    'Départ et bateau': 'Salida y barco',
    'Nom de la course': 'Nombre de la regata',
    'Date de départ': 'Fecha de salida',
    'Heure de départ': 'Hora de salida',
    'Nom du bateau': 'Nombre del barco',
    'Nom ou numéro': 'Nombre o número',
    'Type de bateau': 'Tipo de barco',
    'Vitesse moyenne de travail': 'Velocidad media de trabajo',
    ...
    'Route': 'Ruta',
    'Départ, waypoints et arrivée': 'Salida, waypoints y llegada',
    'Départ': 'Salida',
    'Arrivée': 'Llegada',
    'Nom': 'Nombre',
    'Latitude': 'Latitud',
    'Longitude': 'Longitud',
    'Ajouter un waypoint manuel': 'Añadir un waypoint manual',
    'Carte de route': 'Mapa de ruta',
    ...
    'Distance directe D → A': 'Distancia directa D → A',
    'Route météo calculée': 'Ruta meteorológica calculada',
    'Route météo partielle': 'Ruta meteorológica parcial',
    '1 tronçon': '1 tramo',
    'Météo au passage': 'Meteorología en ruta',
    'Polaire bateau': 'Polar del barco',
    ...
    'Routage météo': 'Routing meteorológico',
    'Isochrones': 'Isócronas',
    'Pas de temps': 'Paso de tiempo',
    'Horizon': 'Horizonte',
    'Coefficient marée': 'Coeficiente de marea',
    'PM générique de secours': 'Pleamar genérica de respaldo',
    'Calculer le routage': 'Calcular el routing',
    'Calcul des isochrones…': 'Calculando isócronas…',
    'Pleines mers par port de référence SHOM': 'Pleamares por puerto SHOM de referencia',
    'Aucune PM saisie': 'No se ha introducido ninguna pleamar',
    'Pourquoi cette route météo ?': '¿Por qué esta ruta meteorológica?',
    'Cap': 'Rumbo',
    'Vent': 'Viento',
    'Polaire': 'Polar',
    'Après mer': 'Tras penalización por mar',
    'Vitesse sol': 'Velocidad sobre el fondo',
    'Courant': 'Corriente',
    'Route retenue': 'Ruta seleccionada',
    'Coupures de terre écartées': 'Cruces de tierra descartados',
    'Options coupant un TSS': 'Opciones que cruzan un TSS',
    'Échantillons courant SHOM': 'Muestras de corriente SHOM',
...
function translateAttributes(element: Element, language: Language) {
  ...
  for (const attribute of attributes) {
    ...
    element.setAttribute(attribute, translated(originals[attribute], language))
  }
}
