...
export function ExpressReading({ request, weather, onChange }: Props) {
  ...
  return <section className="express-reading" aria-labelledby="express-reading-title">
    ...
    <details className="express-entry" open={!latest}>
